    ...
    <header className="h-14 border-b border-zinc-100 flex items-center justify-between px-6 bg-white shrink-0 relative z-40">
      ...
      <div className="flex items-center min-w-0">
        <div className="flex flex-col">
          <span className="text-xl font-black italic tracking-tighter text-darkDelegation leading-none uppercase">
            OfficeMind<span className="text-blue-500">AI</span>
          </span>
          <span className="text-[10px] font-bold text-zinc-400 -mt-0.5 tracking-wide">
            GOOGLE APAC HACKATHON 2026
          </span>
        </div>

        <div className="flex items-center gap-3 self-center ml-4 min-w-0">
